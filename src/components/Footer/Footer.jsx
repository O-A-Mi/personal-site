...
const socialLinks = [
  {
    id: 'instagram',
    label: 'Instagram',
    href: 'https://instagram.com/oa._mi',
    icon: <InstagramIcon />,
  },
  {
    id: 'artistree',
    label: 'Artistree',
    href: 'https://artistree.io/oami',
    icon: <ArtistreeIcon />,
  },
  {
    id: 'github',
    label: 'GitHub',
    href: 'https://github.com/O-A-Mi',
    icon: <GithubIcon />,
  },
  {
    id: 'email',
    label: 'Email',
    href: 'mailto:o.ou.a.mis@gmail.com',
    icon: <EmailIcon />,
  },
];
...
const Footer = () => {
  ...
  return (
    <footer id="social-links" ref={ref} className={styles.footer}>
      ...
      >
        <motion.div className={styles.brandArea} variants={itemVariants}>
          <img
            src="/logoFull.png"
            alt="O MI Logo"
            className={styles.brandLogo}
          />
          <span className={styles.brandName}>O MI</span>
          <span className={styles.brandTagline}>{t.footer.tagline}</span>
        </motion.div>
        ...
        <motion.div className={styles.copyright} variants={itemVariants}>
          <p className={styles.copyrightText}>
            © {currentYear}{' '}
            <span className={styles.copyrightHighlight}>O MI</span>. {t.footer.copyright}
          </p>
